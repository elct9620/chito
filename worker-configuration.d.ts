// Generated by Wrangler by running `wrangler types` (hash: 167d95f8f147dd2fbd27862b4fc2b77a)
// Runtime types generated with workerd@1.20250409.0 2025-04-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		TELEGRAM_BOT_TOKEN: string;
		TELEGRAM_BOT_DOMAIN: string;
		CLOUDFLARE_AI_GATEWAY: string;
		OPENAI_API_TOKEN: string;
		DEPLOYMENT: { id: string; tag: string };
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_BOT_TOKEN" | "TELEGRAM_BOT_DOMAIN" | "CLOUDFLARE_AI_GATEWAY" | "OPENAI_API_TOKEN">> {}
}
