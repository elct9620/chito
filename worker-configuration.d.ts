...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_BOT_TOKEN" | "TELEGRAM_BOT_DOMAIN" | "TELEGRAM_BOT_PATH">> {}
}
